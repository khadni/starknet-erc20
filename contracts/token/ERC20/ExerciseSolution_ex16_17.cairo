...
from contracts.token.ERC20.IKHDERC20 import IKHDERC20
...
func deposit_tracker_token{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}() -> (deposit_tracker_token_address : felt):
    let address = 0x03ee427986ef05ee9d6762bf14f8d7e3b7331ec290b4bac02e4e09d5c3d8e50c
...
func allow_amount{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(amount : Uint256) -> ():
    ...
    let (res) = IDTKERC20.approve(0x066aa72ce2916bbfc654fd18f9c9aaed29a4a678274639a010468a948a5e2a96, custody_address, amount)
    return()
end
...
func increase_amount{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(amount : Uint256) -> ():
    ...
    let (inc_res) = IDTKERC20.increaseAllowance(0x066aa72ce2916bbfc654fd18f9c9aaed29a4a678274639a010468a948a5e2a96, custody_address, amount)
    return()
end
...
func decrease_amount{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(amount : Uint256) -> ():
    ...
    let (inc_res) = IDTKERC20.decreaseAllowance(0x066aa72ce2916bbfc654fd18f9c9aaed29a4a678274639a010468a948a5e2a96, custody_address, amount)
    return()
end
...
func deposit_tokens{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(amount: Uint256) -> (final_amount: Uint256):
    ...
    let dummy_token_address = 0x066aa72ce2916bbfc654fd18f9c9aaed29a4a678274639a010468a948a5e2a96

    IDTKERC20.transferFrom(dummy_token_address,sender=caller_address,recipient=contract_address,amount=amount)

    IKHDERC20.mint(0x03ee427986ef05ee9d6762bf14f8d7e3b7331ec290b4bac02e4e09d5c3d8e50c, caller_address, amount)
